...
class TaskIngest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal[u"_target_name",b"_target_name",u"target_name",b"target_name"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal[u"_target_name",b"_target_name",u"collected_uuid",b"collected_uuid",u"target_name",b"target_name"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal[u"_target_name",b"_target_name"]) -> typing.Optional[typing_extensions.Literal["target_name"]]: ...
